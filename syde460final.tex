...
% TODO: rework this into the rest of this section
...
% workshop.
%TODO: talk about meeting objectives.
A model of a hang glider was derived using physical principles and simulated
using numerical methods (cf. Sections \ref{sec:modelling},
\ref{sec:simulation}).  Nonlinear simulations confirmed the inherent stability
of the craft, although modelling difficulties prevented applying the designed
controller to the simulated craft.

Analysis of the controller shows that the derived performance requirements were
met, despite competing requirements in, for example, the roll response.
